...
/**
 * AccountAddressesTotal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountAddressesTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_addresses_total';
    ...
    protected static $openAPITypes = [
        ...
        'received_sum' => '\OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[]',
        'sent_sum' => '\OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[]',
        'tx_count' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['received_sum'] = $data['received_sum'] ?? null;
        $this->container['sent_sum'] = $data['sent_sum'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['received_sum'] === null) {
            $invalidProperties[] = "'received_sum' can't be null";
        }
        if ($this->container['sent_sum'] === null) {
            $invalidProperties[] = "'sent_sum' can't be null";
        }
     ...
     * Sets stake_address
     *
     * @param string $stake_address Bech32 encoded stake address
     *
     * @return self
     */
     ...
     * Gets received_sum
     *
     * @return \OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[]
     */
    public function getReceivedSum()
    {
        return $this->container['received_sum'];
    }

    /**
     * Sets received_sum
     *
     * @param \OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[] $received_sum received_sum
     *
     * @return self
     */
    public function setReceivedSum($received_sum)
    {
        $this->container['received_sum'] = $received_sum;
     ...
     * @return \OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[]
     */
    public function getSentSum()
    {
        return $this->container['sent_sum'];
    }

    /**
     * Sets sent_sum
     *
     * @param \OpenAPI\Client\Model\AccountAddressesTotalReceivedSum[] $sent_sum sent_sum
     *
     * @return self
     */
    public function setSentSum($sent_sum)
    {
        $this->container['sent_sum'] = $sent_sum;
     ...
     * Sets tx_count
     *
     * @param int $tx_count Count of all transactions for all addresses associated with the account
     *
     * @return self
     */
