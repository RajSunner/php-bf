...
/**
 * AddressContentExtendedAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressContentExtendedAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_content_extended_amount';
    ...
    protected static $openAPIFormats = [
        'unit' => 'Lovelace or concatenation of asset policy_id and hex-encoded asset_name',
        'quantity' => null,
        'decimals' => null,
    ...
    protected static $setters = [
        ...
        'has_nft_onchain_metadata' => 'setHasNftOnchainMetadata'
    ];
    ...
    protected static $getters = [
        ...
        'has_nft_onchain_metadata' => 'getHasNftOnchainMetadata'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_nft_onchain_metadata'] = $data['has_nft_onchain_metadata'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_nft_onchain_metadata'] === null) {
            $invalidProperties[] = "'has_nft_onchain_metadata' can't be null";
        }
     ...
     * Sets quantity
     *
     * @param string $quantity The quantity of the unit
     *
     * @return self
     */
     ...
     * Sets decimals
     *
     * @param int $decimals Number of decimal places of the asset unit
     *
     * @return self
     */
    ...
    /**
     * Gets has_nft_onchain_metadata
     *
     * @return bool
     */
    public function getHasNftOnchainMetadata()
    {
        return $this->container['has_nft_onchain_metadata'];
    }

    /**
     * Sets has_nft_onchain_metadata
     *
     * @param bool $has_nft_onchain_metadata The latest minting transaction includes the NFT metadata according to CIP25
     *
     * @return self
     */
    public function setHasNftOnchainMetadata($has_nft_onchain_metadata)
    {
        $this->container['has_nft_onchain_metadata'] = $has_nft_onchain_metadata;
