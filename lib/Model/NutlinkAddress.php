...
/**
 * NutlinkAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NutlinkAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nutlink_address';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['metadata_url'] = $data['metadata_url'] ?? null;
        $this->container['metadata_hash'] = $data['metadata_hash'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metadata_hash'] === null) {
            $invalidProperties[] = "'metadata_hash' can't be null";
        }
     ...
     * Sets metadata_url
     *
     * @param string $metadata_url URL of the specific metadata file
     *
     * @return self
     */
    ...
    {
        return $this->container['metadata_hash'];
    }

    /**
     * Sets metadata_hash
     *
     * @param string $metadata_hash Hash of the metadata file
     *
     * @return self
     */
    public function setMetadataHash($metadata_hash)
    {
        $this->container['metadata_hash'] = $metadata_hash;
     ...
     * Sets metadata
     *
     * @param array<string,object> $metadata The cached metadata of the `metadata_url` file.
     *
     * @return self
     */
