...
class AssetMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'asset_metadata';
     ...
     * Sets url
     *
     * @param string $url Asset website
     *
     * @return self
     */
     ...
     * Sets logo
     *
     * @param string $logo Base64 encoded logo of the asset
     *
     * @return self
     */
    ...
    public function setDecimals($decimals)
    {
        ...
        if (($decimals > 255)) {
            throw new \InvalidArgumentException('invalid value for $decimals when calling AssetMetadata., must be smaller than or equal to 255.');
        }
