...
/**
 * AddressContent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddressContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_content';
    ...
    const TYPE_BYRON = 'byron';
    const TYPE_SHELLEY = 'shelley';
