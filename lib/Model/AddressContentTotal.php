...
/**
 * AddressContentTotal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddressContentTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_content_total';
    ...
    protected static $openAPITypes = [
        'address' => 'string',
        'received_sum' => '\OpenAPI\Client\Model\TxContentOutputAmount[]',
        'sent_sum' => '\OpenAPI\Client\Model\TxContentOutputAmount[]',
        'tx_count' => 'int'
    ];
     ...
     * Gets received_sum
     *
     * @return \OpenAPI\Client\Model\TxContentOutputAmount[]
     */
     ...
     * Sets received_sum
     *
     * @param \OpenAPI\Client\Model\TxContentOutputAmount[] $received_sum received_sum
     *
     * @return self
     */
     ...
     * Sets sent_sum
     *
     * @param \OpenAPI\Client\Model\TxContentOutputAmount[] $sent_sum sent_sum
     *
     * @return self
     */
     ...
     * Sets tx_count
     *
     * @param int $tx_count Count of all transactions on the address
     *
     * @return self
     */
