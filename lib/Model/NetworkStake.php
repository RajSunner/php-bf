...
/**
 * NetworkStake Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkStake implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_stake';
     ...
     * Sets live
     *
     * @param string $live Current live stake in Lovelaces
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param string $active Current active stake in Lovelaces
     *
     * @return self
     */
