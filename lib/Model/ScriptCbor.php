 ...
 */
class ScriptCbor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'script_cbor';
    ...
    protected static $openAPITypes = [
        'cbor' => 'AnyOfStringObjectArrayIntegerNumberBoolean'
    ];
    ...
    {
        $this->container['cbor'] = $data['cbor'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cbor'] === null) {
            $invalidProperties[] = "'cbor' can't be null";
        }
     ...
     * Gets cbor
     *
     * @return AnyOfStringObjectArrayIntegerNumberBoolean
     */
    public function getCbor()
    {
        return $this->container['cbor'];
    }

    /**
     * Sets cbor
     *
     * @param AnyOfStringObjectArrayIntegerNumberBoolean $cbor CBOR contents of the `plutus` script, null for `timelocks`
     *
     * @return self
     */
    public function setCbor($cbor)
    {
        $this->container['cbor'] = $cbor;
