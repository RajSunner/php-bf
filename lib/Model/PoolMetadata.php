...
/**
 * PoolMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PoolMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pool_metadata';
     ...
     * Sets url
     *
     * @param string $url URL to the stake pool metadata
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string $hash Hash of the metadata file
     *
     * @return self
     */
     ...
     * Sets ticker
     *
     * @param string $ticker Ticker of the stake pool
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Description of the stake pool
     *
     * @return self
     */
     ...
     * Sets homepage
     *
     * @param string $homepage Home page of the stake pool
     *
     * @return self
     */
