...
class Script implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'script_hash' => 'setScriptHash',
        'type' => 'setType',
        'serialised_size' => 'setSerialisedSize'
    ];
    ...
    protected static $getters = [
        'script_hash' => 'getScriptHash',
        'type' => 'getType',
        'serialised_size' => 'getSerialisedSize'
    ];
    ...
    const TYPE_TIMELOCK = 'timelock';
    const TYPE_PLUTUS = 'plutus';
    ...
    {
        $this->container['script_hash'] = $data['script_hash'] ?? null;
        $this->container['type'] = $data['type'] ?? null;
        $this->container['serialised_size'] = $data['serialised_size'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['script_hash'] === null) {
            $invalidProperties[] = "'script_hash' can't be null";
        }
        ...
        if ($this->container['serialised_size'] === null) {
            $invalidProperties[] = "'serialised_size' can't be null";
        }
    ...
    {
        return $this->container['script_hash'];
    }
     ...
     * @return self
     */
    public function setScriptHash($script_hash)
    {
        $this->container['script_hash'] = $script_hash;
     ...
     * Sets type
     *
     * @param string $type Type of the script language
     *
     * @return self
     */
    ...
    /**
     * Gets serialised_size
     *
     * @return int
     */
    public function getSerialisedSize()
    {
        return $this->container['serialised_size'];
    }

    /**
     * Sets serialised_size
     *
     * @param int $serialised_size The size of the CBOR serialised script, if a Plutus script
     *
     * @return self
     */
    public function setSerialisedSize($serialised_size)
    {
        $this->container['serialised_size'] = $serialised_size;
