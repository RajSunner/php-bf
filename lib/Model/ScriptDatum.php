 ...
 */
class ScriptDatum implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'script_datum';
    ...
    protected static $openAPITypes = [
        'json_value' => 'AnyOfStringObjectArrayIntegerNumberBoolean'
    ];
    ...
    {
        $this->container['json_value'] = $data['json_value'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['json_value'] === null) {
            $invalidProperties[] = "'json_value' can't be null";
        }
     ...
     * Sets json_value
     *
     * @param AnyOfStringObjectArrayIntegerNumberBoolean $json_value JSON content of the datum
     *
     * @return self
     */
