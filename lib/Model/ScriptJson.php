 ...
 */
class ScriptJson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'script_json';
    ...
    protected static $openAPITypes = [
        'json' => 'AnyOfStringObjectArrayIntegerNumberBoolean'
    ];
     ...
     * Sets json
     *
     * @param AnyOfStringObjectArrayIntegerNumberBoolean $json JSON contents of the `timelock` script, null for `plutus` scripts
     *
     * @return self
     */
