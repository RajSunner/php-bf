...
class Network implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'supply' => '\OpenAPI\Client\Model\NetworkSupply',
        'stake' => '\OpenAPI\Client\Model\NetworkStake'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['stake'] = $data['stake'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stake'] === null) {
            $invalidProperties[] = "'stake' can't be null";
        }
     ...
     * Gets supply
     *
     * @return \OpenAPI\Client\Model\NetworkSupply
     */
     ...
     * Sets supply
     *
     * @param \OpenAPI\Client\Model\NetworkSupply $supply supply
     *
     * @return self
     */
     ...
     * Gets stake
     *
     * @return \OpenAPI\Client\Model\NetworkStake
     */
     ...
     * Sets stake
     *
     * @param \OpenAPI\Client\Model\NetworkStake $stake stake
     *
     * @return self
     */
