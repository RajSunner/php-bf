...
/**
 * NetworkSupply Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkSupply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_supply';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['treasury'] = $data['treasury'] ?? null;
        $this->container['reserves'] = $data['reserves'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['treasury'] === null) {
            $invalidProperties[] = "'treasury' can't be null";
        }
     ...
     * Sets max
     *
     * @param string $max Maximum supply in Lovelaces
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param string $total Current total (max supply - reserves) supply in Lovelaces
     *
     * @return self
     */
     ...
     * Sets circulating
     *
     * @param string $circulating Current circulating (UTXOs + withdrawables) supply in Lovelaces
     *
     * @return self
     */
     ...
     * Sets locked
     *
     * @param string $locked Current supply locked by scripts in Lovelaces
     *
     * @return self
     */
    ...
    {
        return $this->container['treasury'];
    }

    /**
     * Sets treasury
     *
     * @param string $treasury Current supply locked in treasury
     *
     * @return self
     */
    public function setTreasury($treasury)
    {
        $this->container['treasury'] = $treasury;
     ...
     * Sets reserves
     *
     * @param string $reserves Current supply locked in reserves
     *
     * @return self
     */
