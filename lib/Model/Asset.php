...
class Asset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'onchain_metadata' => 'array<string,object>',
    ...
    protected static $attributeMap = [
        ...
        'mint_or_burn_count' => 'mint_or_burn_count',
    ...
    protected static $setters = [
        ...
        'initial_mint_tx_hash' => 'setInitialMintTxHash',
        'mint_or_burn_count' => 'setMintOrBurnCount',
        'onchain_metadata' => 'setOnchainMetadata',
    ...
    protected static $getters = [
        ...
        'initial_mint_tx_hash' => 'getInitialMintTxHash',
        'mint_or_burn_count' => 'getMintOrBurnCount',
        'onchain_metadata' => 'getOnchainMetadata',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['initial_mint_tx_hash'] = $data['initial_mint_tx_hash'] ?? null;
        $this->container['mint_or_burn_count'] = $data['mint_or_burn_count'] ?? null;
        $this->container['onchain_metadata'] = $data['onchain_metadata'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['initial_mint_tx_hash'] === null) {
            $invalidProperties[] = "'initial_mint_tx_hash' can't be null";
        }
        if ($this->container['mint_or_burn_count'] === null) {
            $invalidProperties[] = "'mint_or_burn_count' can't be null";
        }
        if ($this->container['onchain_metadata'] === null) {
            $invalidProperties[] = "'onchain_metadata' can't be null";
        }
     ...
     * Sets asset
     *
     * @param string $asset Hex-encoded asset full name
     *
     * @return self
     */
     ...
     * Sets policy_id
     *
     * @param string $policy_id Policy ID of the asset
     *
     * @return self
     */
     ...
     * Sets asset_name
     *
     * @param string $asset_name Hex-encoded asset name of the asset
     *
     * @return self
     */
     ...
     * Sets fingerprint
     *
     * @param string $fingerprint CIP14 based user-facing fingerprint
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param string $quantity Current asset quantity
     *
     * @return self
     */
    ...
    /**
     * Gets initial_mint_tx_hash
     *
     * @return string
     */
    public function getInitialMintTxHash()
    {
        return $this->container['initial_mint_tx_hash'];
    }

    /**
     * Sets initial_mint_tx_hash
     *
     * @param string $initial_mint_tx_hash ID of the initial minting transaction
     *
     * @return self
     */
    public function setInitialMintTxHash($initial_mint_tx_hash)
    {
        $this->container['initial_mint_tx_hash'] = $initial_mint_tx_hash;

        return $this;
    }

    /**
     * Gets mint_or_burn_count
     *
     * @return int
     */
    public function getMintOrBurnCount()
    {
        return $this->container['mint_or_burn_count'];
    }

    /**
     * Sets mint_or_burn_count
     *
     * @param int $mint_or_burn_count Count of mint and burn transactions
     *
     * @return self
     */
    public function setMintOrBurnCount($mint_or_burn_count)
    {
        $this->container['mint_or_burn_count'] = $mint_or_burn_count;

        return $this;
    }

    /**
     * Gets onchain_metadata
     *
     * @return array<string,object>
     */
    public function getOnchainMetadata()
    {
        return $this->container['onchain_metadata'];
    }

    /**
     * Sets onchain_metadata
     *
     * @param array<string,object> $onchain_metadata On-chain metadata stored in the minting transaction under label 721, community discussion around the standard ongoing at https://github.com/cardano-foundation/CIPs/pull/85
     *
     * @return self
     */
    public function setOnchainMetadata($onchain_metadata)
    {
        $this->container['onchain_metadata'] = $onchain_metadata;
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\AssetMetadata
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\AssetMetadata $metadata metadata
     *
     * @return self
     */
