...
class MetricsApi
{
     ...
     */
    public function metricsEndpointsGet()
    {
        list($response) = $this->metricsEndpointsGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation metricsEndpointsGetWithHttpInfo
     *
     * Blockfrost endpoint usage metrics
     *
     *
     ...
     */
    public function metricsEndpointsGetWithHttpInfo()
    {
        $request = $this->metricsEndpointsGetRequest();
    ...
    /**
     * Operation metricsEndpointsGetAsync
     *
     * Blockfrost endpoint usage metrics
     *
     *
     ...
     */
    public function metricsEndpointsGetAsync()
    {
        return $this->metricsEndpointsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation metricsEndpointsGetAsyncWithHttpInfo
     *
     * Blockfrost endpoint usage metrics
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metricsEndpointsGetAsyncWithHttpInfo()
    {
        $returnType = 'object[]';
        $request = $this->metricsEndpointsGetRequest();
    ...
    /**
     * Create request for operation 'metricsEndpointsGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function metricsEndpointsGetRequest()
    {

        $resourcePath = '/metrics/endpoints';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object[]|\OpenAPI\Client\Model\InlineResponse400|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse429|\OpenAPI\Client\Model\InlineResponse418|\OpenAPI\Client\Model\InlineResponse500
     */
    public function metricsGet()
    {
        list($response) = $this->metricsGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation metricsGetWithHttpInfo
     *
     * Blockfrost usage metrics
     *
     *
     ...
     * @return array of object[]|\OpenAPI\Client\Model\InlineResponse400|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse429|\OpenAPI\Client\Model\InlineResponse418|\OpenAPI\Client\Model\InlineResponse500, HTTP status code, HTTP response headers (array of strings)
     */
    public function metricsGetWithHttpInfo()
    {
        $request = $this->metricsGetRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metricsGetAsync()
    {
        return $this->metricsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation metricsGetAsyncWithHttpInfo
     *
     * Blockfrost usage metrics
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function metricsGetAsyncWithHttpInfo()
    {
        $returnType = 'object[]';
        $request = $this->metricsGetRequest();
    ...
    /**
     * Create request for operation 'metricsGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function metricsGetRequest()
    {
