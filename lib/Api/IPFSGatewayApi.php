...
/**
 * IPFSGatewayApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class IPFSGatewayApi
{
    ...
    /**
     * Operation ipfsGatewayIPFSPathGet
     *
     ...
     * @return void
     */
    public function ipfsGatewayIPFSPathGet($ipfs_path)
    {
        $this->ipfsGatewayIPFSPathGetWithHttpInfo($ipfs_path);
    }

    /**
     * Operation ipfsGatewayIPFSPathGetWithHttpInfo
     *
     * Relay to an IPFS gateway
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     */
    public function ipfsGatewayIPFSPathGetWithHttpInfo($ipfs_path)
    {
        $request = $this->ipfsGatewayIPFSPathGetRequest($ipfs_path);
    ...
    /**
     * Operation ipfsGatewayIPFSPathGetAsync
     *
     * Relay to an IPFS gateway
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     */
    public function ipfsGatewayIPFSPathGetAsync($ipfs_path)
    {
        return $this->ipfsGatewayIPFSPathGetAsyncWithHttpInfo($ipfs_path)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ipfsGatewayIPFSPathGetAsyncWithHttpInfo
     *
     * Relay to an IPFS gateway
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ipfsGatewayIPFSPathGetAsyncWithHttpInfo($ipfs_path)
    {
        $returnType = '';
        $request = $this->ipfsGatewayIPFSPathGetRequest($ipfs_path);
    ...
    /**
     * Create request for operation 'ipfsGatewayIPFSPathGet'
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://ipfs.blockfrost.io/api/v0
     *
     ...
     */
    public function ipfsGatewayIPFSPathGetRequest($ipfs_path)
    {
        // verify the required parameter 'ipfs_path' is set
        if ($ipfs_path === null || (is_array($ipfs_path) && count($ipfs_path) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ipfs_path when calling ipfsGatewayIPFSPathGet'
            );
        }

        $resourcePath = '/ipfs/gateway/{IPFS_path}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
