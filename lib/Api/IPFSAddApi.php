...
class IPFSAddApi
{
     ...
     * @return \OpenAPI\Client\Model\InlineResponse2003|\OpenAPI\Client\Model\InlineResponse400|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse429|\OpenAPI\Client\Model\InlineResponse418|\OpenAPI\Client\Model\InlineResponse500
     */
    public function ipfsAddPost()
    {
        list($response) = $this->ipfsAddPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation ipfsAddPostWithHttpInfo
     *
     * Add a file to IPFS
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     */
    public function ipfsAddPostWithHttpInfo()
    {
        $request = $this->ipfsAddPostRequest();
     ...
     */
    public function ipfsAddPostAsync()
    {
        return $this->ipfsAddPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ipfsAddPostAsyncWithHttpInfo
     *
     * Add a file to IPFS
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ipfsAddPostAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2003';
        $request = $this->ipfsAddPostRequest();
    ...
    /**
     * Create request for operation 'ipfsAddPost'
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://ipfs.blockfrost.io/api/v0
     *
     ...
     */
    public function ipfsAddPostRequest()
    {

        $resourcePath = '/ipfs/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
